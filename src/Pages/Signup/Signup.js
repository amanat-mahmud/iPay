...
const Signup = () => {
  return (
    <section class=" my-10">
      <div class="">
        <div class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between w-9/12 mx-auto">
          <div class="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
            <img src={img} class="w-full" alt="Sample image" />
          </div>
            ...
            <form>
              ...
              <div class="relative mb-6" data-te-input-wrapper-init>
                <label
                  ...
                  class=" dark:text-neutral-900 dark:peer-focus:text-neutral-900"
                >
                  User Name
                </label>
                <input
